...
namespace App
{
    public partial class Frm_PhieuDiemSV : DevExpress.XtraEditors.XtraForm
    {
        public Frm_PhieuDiemSV()
        {
            InitializeComponent();
        }

        private void Frm_PhieuDiemSV_Load(object sender, EventArgs e)
        {
        ...
        private void BtnIn_Click(object sender, EventArgs e)
        {
            if (ValidatorSV() == false)
            {
                ...
                Xrpt_PhieuDiemSV rpt = new Xrpt_PhieuDiemSV(msv, type);
                rpt.lbMaSV.Text = msv;
